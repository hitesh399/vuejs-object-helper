...
test('Set Value in Object[test deleteProp]', () => {
...
test('Test [pushProp]', () => {
    ...
    const preLength = test_collection.nasted.child.length
    main.pushProp(test_collection, 'nasted.child', { id: 3, name: 'Hitesh Kumar 2' }, 'id', true)
    console.log('test_collection', JSON.stringify( test_collection))
    expect(test_collection.nasted.child.length).toBe(preLength)
